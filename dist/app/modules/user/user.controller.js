...
const createUser = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _a = yield user_service_1.UserService.createUser(req.body), { password } = _a, data = __rest(_a, ["password"]);
...
const userProfile = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { userId } = yield user_service_1.UserService.userProfile(refreshToken);
